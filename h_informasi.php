		...
		<div class="row s_product_inner">
			...
			<div class="col-lg-5 offset-lg-1">
				<div class="s_product_text">
					...
					<ul class="list">
						<!-- <li><a name="penerbit" id="penerbit"><span>penerbit</span> : <? //$r['penerbit']; 
																							?></a></li> -->
						<table class="table">
							<tbody>
								<tr>
					...
					<p></p>
					<!-- <p>Deskripsi Buku : <?= $r['deskripsi_b']; ?></p> -->
					<div class="generic-btn info radius text-center">
						<a href="h_admin.php" class="genric-btn success radius text-center">
							Kembali
						</a>
					</div>
				</div>
