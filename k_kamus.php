...
<div class="container">
	<div class="row">
		...
		<div class="col-xl-9 col-lg-8 col-md-7">
			...
			if (isset($_GET['cari'])) {
				$cari = $_GET['cari'];
				$query = mysqli_query($koneksi, "SELECT * FROM buku where kategori = 'Kamus' and judul like '%$cari%' or pengarang like '%$cari%'");
			} else {
				$n = isset($_GET['page']) ? $_GET['page'] : 1;
				$limit_awal = $n * 8 - 7;
				$limit_akhir = $limit_awal + 8;
				$query = mysqli_query($koneksi, "SELECT * FROM buku where kategori = 'Kamus' limit $limit_awal, $limit_akhir");

				$banyak = mysqli_query($koneksi, "SELECT count(id) FROM buku where kategori='Kamus'");
									...
									<div class="product-details">
										...
										<div class="blog_post blog_info">
											<ul class="blog_meta text-center">
												<li>
													<a href="informasi.php?id=<?= $data['id_buku']; ?>&kategori= Kamus" class="white_bg_btn">Informasi</a>
												</li>
											</ul>
											<ul class="blog_meta text-center">
												<!-- <li>
